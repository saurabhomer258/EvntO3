...
public class SurpriseParty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surprise_party);
    ...
    private void initView() {
        ...
        if (isNetworkAvailable()) {
            AsyncPost asyncPost = new AsyncPost(SurpriseParty.this, new ResponseListener() {
                @Override
                public void onResponse(String result) {
                    ...
                    birthdayAdapter.setOnClickListner(new BirthdayAdapter.OnItemClickListener() {
                        ...
                        public void OnItemClick(int position) {
                            Intent intent = new Intent(SurpriseParty.this,OnItemClic.class);
