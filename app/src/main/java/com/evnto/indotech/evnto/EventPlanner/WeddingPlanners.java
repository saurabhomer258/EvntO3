...
public class WeddingPlanners extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if (isNetworkAvailable()) {
            AsyncPost asyncPost = new AsyncPost(WeddingPlanners.this, new ResponseListener() {
                @Override
                public void onResponse(String result) {
                    ...
                    weddingAdapter.setOnClickListner(new WeddingAdapter.OnItemClickListener() {
                        ...
                        public void OnItemClick(int position) {
                            Intent intent = new Intent(WeddingPlanners.this,OnItemClic.class);
